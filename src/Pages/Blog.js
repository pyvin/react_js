                ...
                <Row>
                    <Col md="9"  className="mt-5">
                        <Media>
                            ...
                            <Media.Body>
                                <h5>Blog post</h5>
                                <p><span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A ipsa quae reprehenderit sapiente voluptas. Cum dicta dolorum ducimus ea eveniet hic in possimus quia rem repudiandae, saepe sint, sunt ullam.</span><span>Aperiam aut commodi error hic natus nemo non, quod rem totam voluptates. Debitis deleniti dicta ipsum tempore! Accusamus aperiam culpa debitis ducimus et facere, impedit laudantium necessitatibus nulla, reprehenderit temporibus.</span></p>
                            </Media.Body>
                        </Media>
                    ...
                    <Col md="3">
                        ...
                        <Card className="mt-5" bg="light">
                            <Card.Body>
                                <Card.Title>Site WIDJ</Card.Title>
                                <Card.Text>
                                    <div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet dicta
                                        dignissimos eaque esse eum, eveniet ex fuga fugiat hic, id ipsum iure libero
                                        molestiae praesentium, quam quas recusandae voluptate! Veniam?
                                    </div>
                                </Card.Text>
                            </Card.Body>
                        </Card>
